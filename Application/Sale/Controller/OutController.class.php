...
class OutController extends AuthController {
    ...
    public function add() {
        ...
        if (!IS_POST) {
            ...
            $cc = $out->field("outprice,outpresell")->where("barcode = $code")->order("id desc")->find();
            ...
            $data['outprice'] = $cc['outprice'];
            $data['outamount'] = $outamount;
            $data['outsum'] = $outamount * $cc['outprice'];
            $data['outpresell'] = $cc['outpresell'];
